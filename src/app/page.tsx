  ...
  return (
    <div className="flex flex-col min-h-screen bg-background">
              ...
              <div className="flex flex-col justify-center space-y-4">
                <div className="space-y-2">
                  <h1 className="text-3xl font-bold tracking-tighter sm:text-5xl xl:text-6xl/none">
                    Smart Monitoring for Temperature and Dust
                  </h1>
                  <p className="max-w-[600px] text-muted-foreground md:text-xl">
                    TDMS provides real-time data, AI-powered insights, and predictive alerts to keep your environment safe and sound.
                  </p>
                </div>
          ...
          <div className="container px-4 md:px-6">
            <div className="flex flex-col items-center justify-center space-y-4 text-center">
              <div className="space-y-2">
                ...
                <p className="max-w-[900px] text-muted-foreground md:text-xl/relaxed lg:text-base/relaxed xl:text-xl/relaxed">
                  From real-time sensor data to predictive AI, TDMS has you covered.
                </p>
              </div>
            </div>
            <div className="mx-auto grid max-w-5xl items-start gap-8 py-12 sm:grid-cols-2 md:gap-12 lg:grid-cols-3">
              ...
              <div className="grid gap-2 text-center">
                ...
                <p className="text-muted-foreground">
                  Ask questions in natural language and get instant insights about your environment conditions.
                </p>
              </div>
              <div className="grid gap-2 text-center">
                <div className="flex justify-center">
      ...
      <footer className="flex flex-col gap-2 sm:flex-row py-6 w-full shrink-0 items-center px-4 md:px-6 border-t">
        <p className="text-xs text-muted-foreground">&copy; 2024 TDMS. All rights reserved.</p>
